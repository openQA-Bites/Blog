...
tags:
  ...
  - tools
---
When updating the `dependecies.yaml` file in [os-autoinst](https://github.com/os-autoinst/os-autoinst), e.g. when you'd like to [fix the outdated perltidy version in the repo](/posts/2022/2022-03-04-perltidy/) the recommended workflow is to:
